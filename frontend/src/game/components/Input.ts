...
export default class InputManager implements IInput {
    ...
    public getMovementInput(): Phaser.Math.Vector2 {
    ...
    public getKeyboardAimInput(): Phaser.Math.Vector2 | null {
     ...
     */
    public getMouseAimInput(playerX: number, playerY: number): Phaser.Math.Vector2 | null {
    ...
    public getMouseWorldPosition(): Phaser.Math.Vector2 | null {
